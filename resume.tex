...
\begin{ncolumn}{2}
  {\it Senior Software Engineer}  &   {\hspace*{\fill} Feb 2023 -- Present}
\end{ncolumn}\\
DriveCentric, LLC. -- Remote
\begin{itemize}[noitemsep]
  \item Developer on inventory and appraisal integration team
  \item Lead developer on Angular user interface for inventory management
  \item Contribute to architecture and migration of dynamic inventory processing system
\end{itemize}
